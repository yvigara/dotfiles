...
if [[ "$TERM" != screen && "$ITERM_SHELL_INTEGRATION_INSTALLED" = "" && "$-" == *i* ]]; then
  ...
  function iterm2_print_version_number() {
    ...
    iterm2_begin_osc
    printf "6;1;bg;red;brightness;$1"
    iterm2_end_osc
    iterm2_begin_osc
    printf "6;1;bg;green;brightness;$1"
    iterm2_end_osc
    iterm2_begin_osc
    printf "6;1;bg;blue;brightness;$1"
    iterm2_end_osc
	}

	function iterm2_tab_reset () {
    iterm2_begin_osc
    printf "6;1;bg;*;default"
    iterm2_end_osc
	}

	function tab-red () {
		iterm2_tab_color 255 0 0
	}

	function tab-green () {
		iterm2_tab_color 0 255 0
	}

	function tab-blue () {
		iterm2_tab_color 0 0 255
	}
...
if [[ -n "$ITERM_SESSION_ID" ]]; then
  ...
  function iterm2_tab_preexec() {
			if [[ "$1" =~ "^ssh " ]]; then
					if [[ "$1" =~ "prod" ]]; then
							iterm2_tab_color 255 160 160
					else
							iterm2_tab_color 160 255 160
					fi
			else
					iterm2_tab_color 160 160 255
			fi
	}
